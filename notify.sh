...
git remote add github https://$GITHUB_TOKEN@github.com/lee/el-sku.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/lee/el-sku/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "el-sku更新", "text": "@所有人\n# [el-sku('$version')]('$html_url')\n'$body'"}}'
